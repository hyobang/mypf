...
!(function () {
  ...
  var O = {
    ...
    updateSlides: function () {
      ...
      for (let a = 0; a < m; a += 1) {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            (z = (n - (i.slidesPerView - 1) * A) / i.slidesPerView),
              i.roundLengths && (z = Math.floor(z)),
      ...
      if (
        ...
        P && e.grid.updateWrapperSize(z, h, t),
        !i.centeredSlides)
      ) {
        const t = [];
    ...
    updateAutoHeight: function (e) {
      ...
      const n = (e) => (i ? t.getSlideIndexByData(e) : t.slides[e]);
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((a) => {
          if (!s[a] && !0 === s.auto) {
            let r = f(e.el, `.${i[a]}`)[0];
            r || ((r = g("div", i[a])), (r.className = i[a]), e.el.append(r)),
              (s[a] = r),
              (t[a] = r);
          }
        }),
  ...
  const ue = [
    ...
    function (e) {
      ...
      function c(e) {
        ...
        if (t.params.loop) {
          ...
          (i < t.loopedSlides || i > t.slides.length - t.loopedSlides) &&
            t.loopFix({
    ...
    function (e) {
      ...
      function T() {
        ...
        "string" == typeof i.el &&
          t.isElement &&
          (a = t.el.shadowRoot.querySelector(i.el)),
          ...
          a &&
            ...
            r || ((r = g("div", t.params.scrollbar.dragClass)), a.append(r))),
          Object.assign(e, { el: a, dragEl: r }),
          i.draggable && t.params.scrollbar.el && t.scrollbar.el && A("on"),
          a &&
      ...
      function M() {
        ...
        s &&
          ...
          t.params.scrollbar.el && t.scrollbar.el && A("off");
      }
      s({
        scrollbar: {
          el: null,
        ...
        a("init", () => {
          !1 === t.params.scrollbar.enabled ? C() : (T(), w(), f());
        }),
    ...
    function (e) {
      ...
      function C(e) {
        ...
        let a, r, l, o, d, c, u, g, w, b, x, E, S, A, T, M, C, P;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
        ...
        1 === p && z && ((a = void 0), (r = void 0)),
          ...
          !e || (1 === p && z)
            ...
            : ((C = m.slideEl.offsetWidth),
              ...
              (x = w * s.scale),
              (E = b * s.scale),
              (S = Math.min(C / 2 - x / 2, 0)),
              (A = Math.min(P / 2 - E / 2, 0)),
              (T = -S),
              (M = -A),
              (u = d * s.scale),
              (g = c * s.scale),
      ...
      function I() {
        ...
        t.wrapperEl.removeEventListener("pointerdown", E, s),
          ...
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.removeEventListener(e, A, s);
          }),
              ...
              for (let i = 0, a = t.slides.length; i < a; i += 1) {
                ...
                if (
                  (a.getAttribute("data-hash") ||
                    a.getAttribute("data-history")) === e
                ) {
                  const e = t.getSlideIndex(a);
    ...
    function (e) {
      ...
      function b(e) {
        a &&
          ...
          (a.wrapperEl.removeEventListener("transitionend", b), T());
      }
      const y = () => {
      ...
      n("init", () => {
        a.params.autoplay.enabled &&
          (a.params.autoplay.pauseOnMouseEnter &&
            (a.el.addEventListener("pointerenter", C),
        ...
        n("beforeTransitionStart", (e, t, s) => {
          !a.destroyed &&
            a.autoplay.running &&
            (s || !a.params.autoplay.disableOnInteraction ? A(!0, !0) : S());
        }),
        n("sliderFirstMove", () => {
          !a.destroyed &&
            a.autoplay.running &&
        ...
        Object.assign(a.autoplay, { start: E, stop: S, pause: A, resume: T });
    },
    function (e) {
        ...
        (a.grid = {
          ...
          updateSlide: (e, r, n, l) => {
            const { slidesPerGroup: o, spaceBetween: d } = a.params,
              { rows: p, fill: c } = a.params.grid;
            let u, m, h;
            if ("row" === c && o > 1) {
              const s = Math.floor(e / (o * p)),
                i = e - p * o * s,
                a = 0 === s ? o : Math.min(Math.ceil((n - s * p * o) / p), o);
              (h = Math.floor(i / a)),
                (m = i - h * a + s * o),
                (u = m + (h * t) / p),
                (r.style.order = u);
          ...
          updateWrapperSize: (e, s, i) => {
            ...
            if (
              ...
              (a.wrapperEl.style[i("width")] = `${a.virtualSize + r}px`),
              n)
            ) {
              const e = [];
    ...
    function (e) {
      ...
      const a = (e, t, s) => {
        ...
        i ||
          ((i = g("div", "swiper-slide-shadow-" + (s ? "left" : "top"))),
          e.append(i)),
          a ||
            ((a = g("div", "swiper-slide-shadow-" + (s ? "right" : "bottom"))),
            e.append(a)),
      ...
      const a = (e, s, i) => {
        let a = t.isHorizontal()
          ...
          r = t.isHorizontal()
            ? e.querySelector(".swiper-slide-shadow-right")
            : e.querySelector(".swiper-slide-shadow-bottom");
        a || (a = ce(0, e, t.isHorizontal() ? "left" : "top")),
          ...
          setTranslate: () => {
            ...
            for (let l = 0; l < e.length; l += 1) {
              ...
              t.params.centeredSlides &&
                ...
                t.params.centeredSlides &&
                  t.params.cssMode &&
                  (c -= e[0].swiperSlideOffset);
              let u = t.params.cssMode ? -c - t.translate : -c,
                m = 0;
              const h = -100 * Math.abs(p);
              let f = 1,
                g = -i.perSlideRotate * p,
                v = i.perSlideOffset - 0.75 * Math.abs(p);
              const w =
                  t.virtual && t.params.virtual.enabled
                    ? t.virtual.from + l
                    : l,
  ...
  function be(e) {
    ...
    return (
      i.forEach((t) => {
        (t = t.replace("_", "")), void 0 !== e[t] && (s[t] = e[t]);
      }),
      [...e.attributes].forEach((e) => {
        const t = we.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const i = ge(t),
            a = ge(e.name.split(`${t}-`)[1]);
          s[i] || (s[i] = {}),
            !0 === s[i] && (s[i] = { enabled: !0 }),
            (s[i][a] = ve(e.value));
        } else {
          ...
          const i = ve(e.value);
          s[t] && we.includes(e.name)
            ? (s[t].constructor !== Object && (s[t] = {}), (s[t].enabled = i))
            : (s[t] = i);
        }
      }),
      fe(t, s),
      ...
      y &&
        (t.isElement &&
          ((r && "string" != typeof r) ||
            ...
            t.el.shadowEl.appendChild(r)),
          (n && "string" != typeof n) ||
            ((n = document.createElement("div")),
            n.classList.add("swiper-button-prev"),
            t.el.shadowEl.appendChild(n))),
  ...
  const Se = (e, t) => {
    ...
    !e &&
      ...
      (s && !i) ||
        ...
        (s.textContent = [xe, t ? t.cssStyles() : ""].join("\n")),
        (s.id = "swiper-element-styles"),
        (s.preInit = e),
  ...
  class Te extends Ae {
    ...
    attributeChangedCallback(e, t, s) {
      this.initialized && this.updateSwiperOnPropChange(e, s);
    }
